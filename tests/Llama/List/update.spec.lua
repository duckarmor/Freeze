return function()
	...
	-- Freeze: Deviation -- List.update requires updater function
	...
	-- Freeze: Deviation -- List.update does not have a callback argument
	itSKIP("should call callback if index does not exist and create entry if provided", function()
		local a = {
			"foo",
			"bar",
		}
