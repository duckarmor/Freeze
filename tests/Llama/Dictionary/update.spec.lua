return function()
	...
	-- Freeze: Deviation -- update requires an updater function
	itSKIP("should return a new table", function()
		local a = {}
	...
	-- Llama: Broken test
	itSKIP("should not mutate passed in tables", function()
		local a = {
			foo = 1,
			bar = 2,
			baz = 3,
	...
	-- Freeze: Deviation -- There is no callback parameter on update
	itSKIP("should call callback if key does not exist and create entry if provided", function()
		local a = {
			foo = 1,
			bar = 2,
		}
	...
	-- Freeze: Deviation -- There is no callback parameter on update
	itSKIP("should pass key and value to update and callback", function()
		local a = {
			foo = 1,
			bar = 2,
		}
